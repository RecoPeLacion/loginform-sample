...
function addStudent(){
    ...
    const gradeValue= document.getElementById('grade & section').value;
    const strandValue = document.getElementById('strand').value;
    ...
    if(document.querySelector("#submit").innerText == "Edit Student"){
        ...
        studentobj['studentname'] = nameValue;
        studentobj['email'] = emailValue;
        studentobj['grade & section'] = gradeValue;
        studentobj['age'] = ageValue;
        studentobj['strand'] = degreeValue;
    ...
    if(studentnameValue=='' || emailValue=='' || ageValue=='' || grade&sectionValue =='' || strandValue==""){
...
function showTable(){
    ...
    students.forEach((student)=>{
        ...
        const strand = document.createElement('td');
        ...
        keys.forEach((key)=>{
            ...
            degree.innerHTML = `<div class='strand'><div>${student[key]}</div> <div class="icons"><a onClick="edit(${student['ID']})" class='fa'>&#xf044;</a> <a onClick="del(${student['ID']})" class='fa'>&#xf1f8;</a> </div></div> `;

            row.appendChild(id);
            row.appendChild(studentname);
            row.appendChild(email);
            row.appendChild(age);
            row.appendChild(grade & section);
...
function edit(id) {
    ...
    document.querySelector("#grade & section").value = student['grade & section'];
    document.querySelector("#age").value = student['age'];
    document.querySelector("#strand").value = student['strand'];
